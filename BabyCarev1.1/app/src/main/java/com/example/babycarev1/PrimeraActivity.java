...
public class PrimeraActivity extends AppCompatActivity {
    ...
    protected Button botonVerUsuarios, botonCrearCuidadores;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonVerUsuarios = (Button) findViewById(R.id.boton4_primera);
        botonCrearCuidadores = (Button) findViewById(R.id.boton5_primera);
